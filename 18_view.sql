...
INSERT INTO tbl_menu values(99, '수정과맛국밥', 5500, 4, 'Y');
 ...
 * 2) 뷰에 포함되지 않은 컬럼 중에 베이스가 되는 테이블 컬럼이 not null 계약조건이 지정된 경우
 * 3) 산술 표현식이 정의된 경우
...
-- view에 쓰던 subQuery안에 연산 결과 컬럼도 사용 가능하다.
...
INSERT INTO hansik VALUES ("막국수 족발 점심 특선 세트", 15000, "한식");
